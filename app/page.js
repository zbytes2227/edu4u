  ...
  return (
    <>
      ...
      <div className="mx-auto container p-4 justify-between text-center">
        ...
        <div className="mx-auto container flex-col flex justify-between text-center p-5 max-w-max">

          <a href="#" class="mt-2 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 mx-2">
          ...
          <a href="#" class="mt-2 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 mx-2">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Total Updates</h5>
            <p class="font-extrabold text-3xl text-gray-700 ">{Dashboard.Updates}</p>
          </a>

          <a href="#" class="mt-2 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 mx-2">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Total Notes</h5>
