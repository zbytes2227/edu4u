...
const handler = async (req, res) => {
    if (req.method === "POST") {
        try {
            ...
            const { CustomerID, CustomerName, CustomerPhone, CustomerEmail,CustomerBranch,CustomerCollege } = req.body;
            ...
            foundCard.CustomerBranch = CustomerBranch;
            foundCard.CustomerCollege = CustomerCollege;
